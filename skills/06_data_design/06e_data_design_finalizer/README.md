...
Consolidate Stage 6 artifacts, resolve contradictions, update traceability, record N/A items, prepare result.md, update context_packet.md for Stage 7, and present the approval gate.

This is a reusable skill support guide. It is not a project artifact and it does not replace the executable `SKILL.md`.

## 2. When to use it

Use this sub-skill as part of Stage 6 after the previous required Stage 6 context is available. It answers: Are the Stage 6 data design artifacts complete, consistent, traceable, and safe enough for human review and downstream MVP slicing?
...
- `/skills/06_data_design/06d_security_retention_migration/SKILL.md` — Read the previous sub-skill procedure or use it to understand expected upstream Stage 6 draft artifacts.
...
- `/workflow/06_data/06_data_design_traceability.md` — Consolidated Stage 6 traceability.
- `/workflow/06_data/result.md` — Final Stage 6 result and approval package.
...
- access control and security rule direction
- retention/deletion policy direction
- migration and seed strategy
- N/A classifications for conditional artifacts
...
- Previous stage or sub-skill: `/skills/06_data_design/06d_security_retention_migration/SKILL.md`
- Next stage or sub-skill: `Stage 7 MVP Scope and Release Slicing`
