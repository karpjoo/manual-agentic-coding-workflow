...
Identify data design scope, extract data-relevant requirements, classify data categories, and draft the conceptual data model.

This is a reusable skill support guide. It is not a project artifact and it does not replace the executable `SKILL.md`.

## 2. When to use it

Use this sub-skill as part of Stage 6 after the previous required Stage 6 context is available. It answers: What data does the system need to know about, own, derive, cache, audit, retain, delete, or receive from external systems before choosing concrete schema structures?
...
- Previous stage or sub-skill: `Stage 6 parent entrypoint / approved prior-stage artifacts`
- Next stage or sub-skill: `06b Logical Schema and Query Patterns`
