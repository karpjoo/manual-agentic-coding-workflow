...
Define data security rules, retention/deletion policy, migration/seed strategy, and applicable external/event/blob/analytics data models.

This is a reusable skill support guide. It is not a project artifact and it does not replace the executable `SKILL.md`.

## 2. When to use it

Use this sub-skill as part of Stage 6 after the previous required Stage 6 context is available. It answers: How must each data object be protected, retained, deleted, migrated, seeded, synced, audited, exported, or purged so that the data design is safe, traceable, and ready for MVP slicing?
...
- `/skills/06_data_design/06c_physical_schema_indexes/SKILL.md` — Read the previous sub-skill procedure or use it to understand expected upstream Stage 6 draft artifacts.
...
- data security rule candidates
- sensitive data handling assumptions
- retention/deletion rule candidates
- migration and seed strategy
- external/event/blob/analytics data model applicability
...
- Previous stage or sub-skill: `/skills/06_data_design/06c_physical_schema_indexes/SKILL.md`
- Next stage or sub-skill: `06e Data Design Finalizer`
