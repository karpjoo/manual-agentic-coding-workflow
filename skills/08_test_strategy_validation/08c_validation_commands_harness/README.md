...
Define validation commands, placeholders, fixture and test data needs, harness prerequisites, CI applicability, and command gaps.

Core question:

```text
What commands, fixtures, environments, and harness prerequisites will allow Stage 8 tests to be executed later with reliable evidence?
```

## 2. When to use it

Use this sub-SKILL as step 3 in the Stage 8 sequence.
...
- `/workflow/08_test_strategy/08_validation_commands.md` — Validation command inventory and harness plan
- `/workflow/08_test_strategy/08_test_data_fixtures.md` — Fixture and test data plan, if applicable
- `/workflow/08_test_strategy/08_ci_validation_plan.md` — CI validation plan, if applicable
...
7. Continue to `08d_manual_specialized_validation` only after the output is coherent enough for the next sub-SKILL.
