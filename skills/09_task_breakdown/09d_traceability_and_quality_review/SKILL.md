---
name: 09d_traceability_and_quality_review
description: Review Stage 9 task artifacts for coverage, traceability, task size, validation linkage, and readiness for finalization.
stage: 09 Task Breakdown
parent_skill: /skills/09_task_breakdown/SKILL.md
subskill_id: 09d
subskill_order: 4
previous_subskill: /skills/09_task_breakdown/09c_dependency_ordering/SKILL.md
next_subskill: /skills/09_task_breakdown/09e_task_breakdown_finalizer/SKILL.md
version: 1.0.0
status: draft
primary_output: /workflow/09_tasks/09_traceability_matrix.md
requires_human_approval: true
external_visibility: internal
---

# 09d 09D Traceability And Quality Review

## 1. Purpose

Verify that task inventory, task cards, and dependency order are complete, traceable, properly sized, test-aware, and ready to be finalized for human approval.

## 2. When to Use

Use this as sub-skill 4 of Stage 9 Task Breakdown. It must be run within `/skills/09_task_breakdown/` and should not be treated as an independent public stage.
...
1. Review every task card.
2. Verify requirement or enabling rationale.
3. Verify acceptance criteria or validation basis.
4. Verify required tests, manual validation, definition of done, and bounded change scope.
5. Check security, migration, and integration flags.
6. Verify out-of-scope and rejected items were not converted into tasks.
7. Verify all must-have requirements are covered or recorded as gaps.
8. Create or update 09_traceability_matrix.md.
...
- Enabling Task Justification
- Coverage Gaps
- Oversized or Vague Tasks
- Security / Privacy Traceability
- Migration / Data Traceability
- Integration Traceability
- Stage 10 Readiness Review
- Handoff Notes for 09e
...
- implement code
- silently fix task scope by inventing requirements
- ignore coverage gaps
- mark unvalidated tasks as ready
