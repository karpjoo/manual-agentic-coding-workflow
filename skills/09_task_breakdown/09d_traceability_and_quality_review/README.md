...
Run it as step 4 in the Stage 9 sequence.

Previous sub-SKILL:

```text
/skills/09_task_breakdown/09c_dependency_ordering/SKILL.md
```

Next sub-SKILL:

```text
/skills/09_task_breakdown/09e_task_breakdown_finalizer/SKILL.md
```
