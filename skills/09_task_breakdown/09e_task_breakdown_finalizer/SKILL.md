---
name: 09e_task_breakdown_finalizer
description: Consolidate Stage 9 task breakdown artifacts, prepare result.md, update context_packet.md for Stage 10, and present the human approval gate.
stage: 09 Task Breakdown
parent_skill: /skills/09_task_breakdown/SKILL.md
subskill_id: 09e
subskill_order: 5
previous_subskill: /skills/09_task_breakdown/09d_traceability_and_quality_review/SKILL.md
next_subskill: /skills/10_implementation_prompt_writing/SKILL.md
version: 1.0.0
status: draft
...
Use this as sub-skill 5 of Stage 9 Task Breakdown. It must be run within `/skills/09_task_breakdown/` and should not be treated as an independent public stage.
...
1. Read all mandatory Stage 9 artifacts.
2. Check consistency across task inventory, task cards, dependency order, and traceability matrix.
3. Confirm task IDs match across artifacts.
4. Confirm every task has tests or validation, definition of done, and bounded change scope.
5. Confirm conditional artifacts were created or marked N/A.
6. Update context files as appropriate, excluding DECISIONS.md unless explicit approval exists.
7. Create result.md.
8. Update context_packet.md for Stage 10.
9. Present the human approval gate.
