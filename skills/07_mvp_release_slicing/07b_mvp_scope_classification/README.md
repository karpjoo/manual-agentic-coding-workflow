...
Draft MVP scope by classifying requirements and capabilities into scope categories with rationale, dependencies, risks, and approval needs.
...
Use this as sub-SKILL 2 in Stage 7.

Uses 07a internal inventory and produces the main MVP scope draft for 07c and finalizer review.
...
- `/workflow/07_mvp_release/07_mvp_scope.md` — Defines MVP scope classification, supporting/enabling scope, risks, assumptions, and human approval needs.
- `/workflow/07_mvp_release/_internal/07b_mvp_scope_classification_notes.md` — Records classification reasoning and handoff notes for 07c.
...
Run 07c_release_slicing_dependency to turn the draft MVP scope into release slices.
