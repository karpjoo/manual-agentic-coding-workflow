...
Clarify what is deferred, what is explicitly out of scope, what is rejected, and what risks or scope creep patterns need human review.
...
Use this as sub-SKILL 4 in Stage 7.

Uses 07c release slices and prepares out-of-scope and deferral records for finalizer review.
...
- `/workflow/07_mvp_release/07_out_of_scope.md` — Records deferred items, explicit non-scope items, rejected options, scope creep watchlist, and human approval needs.
- `/workflow/07_mvp_release/_internal/07d_deferral_risk_notes.md` — Records deferral and risk reasoning for finalizer consolidation.

Conditional outputs:

- `/workflow/07_mvp_release/07_release_risk_register.md` — Release sequencing introduces significant risks.
...
Run 07e_mvp_release_finalizer to consolidate official Stage 7 artifacts and prepare Stage 8 handoff.
